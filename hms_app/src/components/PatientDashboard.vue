        ...
        <div class="container mt-4">
          <div class="row mb-4">
            <div class="col-md-2 d-flex flex-column">
              <h3>Appointments</h3>
              <button @click="toggleCreateAppointment" class="btn btn-success ml-2">Add New Appointment</button>
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <tr v-for="patient in filteredPatients" :key="patient.id">
                      ...
                      <td class="text-center">
                        <button @click="toggleEditPatient(patient.id)" class="btn btn-success btn-sm">Edit</button>
                      </td>
                    </tr>
                  </tbody>
                </table>

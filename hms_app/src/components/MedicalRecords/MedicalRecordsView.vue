    ...
    <div class="container mt-4">
      ...
      <div class="row mt-4">
        <div class="col-md-6 d-flex align-items-center">
          ...
          <button @click="toggleCreateMedicalRecord" class="btn btn-success ml-2">Add</button>
        </div>
            ...
            <tbody>
              <tr v-for="record in paginatedMedicalRecords" :key="record.id">
                ...
                <td class="text-center">
                  <button @click="toggleEditMedicalRecord(record.id)" class="btn btn-success ms-2">Edit</button>

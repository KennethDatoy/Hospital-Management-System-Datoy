  ...
  <div class="container">
    ...
    <div class="row mt-2">
      <div class="col-12 col-md-6 mb-2 mb-md-0">
        <button @click="toggleCreateUser" class="btn btn-success w-100 w-md-auto">Create New User</button>
      </div>
          ...
          <tbody>
            <tr v-for="user in paginatedUsers" :key="user.id">
              ...
              <td class="text-center">
                <button @click="toggleEditUser(user.id)" class="btn btn-success ms-2">Edit</button>
